(() => {
    ...
    var qt = !1;
    function Ut() {
        qt && S("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."),
            (qt = !0),
...
`
    ...
    function pt(e) {
        let t = [],
            r = (a) => t.push(a),
            [n, i] = Vt(e);
        return t.push(i), [{ Alpine: j, effect: n, cleanup: r, evaluateLater: x.bind(x, e), evaluate: R.bind(R, e) }, () => t.forEach((a) => a())];
    }
    function Rn(e, t) {
        let r = () => {},
            n = _t[t.type] || r,
    ...
    p("model", (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
        ...
        let c = () => {
            ...
            l = (m) => {
                let w;
                s((k) => (w = k)), pn(w) ? w.set(m) : a(() => {}, { scope: { __placeholder: m } });
            };
        typeof r == "string" &&
            e.type === "radio" &&
            h(() => {
    ...
    te(De(":", Ie(C("bind:"))));
    var mn = (e, { value: t, modifiers: r, expression: n, original: i }, { effect: o }) => {
        if (!t) {
            let a = {};
            Fr(a),
                x(e, n)(
        ...
        r((s) => {
            ...
            for (let f = 0; f < d.length; f++) {
                ...
                N(se, Bt, o),
                    ...
                    typeof X == "object" && S("x-for key cannot be an object, it must be a string or an integer", o),
                    (a[X] = se);
            }
