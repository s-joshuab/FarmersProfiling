    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" id="dashboard-link" data-bs-target="#dashboard"
               href="{{ url('staff/dashboard') }}" onclick="setActiveNavItem(this)">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('staff/farmreport') }}" onclick="setActiveNavItem(this)">
        ...
        <!-- Reports Page Nav -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('staff/reports') }}" onclick="setActiveNavItem(this)">
        ...
        <li class="nav-item">
            ...
            <ul id="settings-nav" class="nav-content">
                <li>
                    <a href="{{ url('staff/profile') }}" class="nav-item nav-link" style="background-color: #00d3fd;">
                        <i class="bi bi-person-circle" style="font-size: 16px;"></i><span style="color: #0000000;">Profile</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('staff/audit') }}" class="nav-item nav-link" style="background-color: #00d3fd;">
                        <i class="bi bi-journal-text" style="font-size: 16px;"></i><span style="color: #0000000;">Audit Trail</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('staff/manageusers') }}" class="nav-item nav-link" style="background-color: #00d3fd;">
                        <i class="bi bi-people" style="font-size: 16px;"></i><span style="color: #0000000;">Manage Users</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('staff/backup') }}" class="nav-item nav-link" style="background-color: #00d3fd;">
